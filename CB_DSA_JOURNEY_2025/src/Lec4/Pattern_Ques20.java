...
int row=1;
int space=N/2; // In row1 there are 3 space so in N term N/2=7/2=3.5=3
int star=1;
...
if(j==1 || j==star)  //Bcoz at every row's first and last position there is star and in between them there are spaces
{                
System.out.print("* ");
}
